...
public class FractureEvents : MonoBehaviour, IShootable
{
    [SerializeField]
    ...
    //when it dies, it plays an explosion effect and drops stuff
    float currentHealth;
    int amountToSpawn;
    ...
    public void CalculateDrops() //based on the info in the lootable list, calculate if the drops will happen, and how many to drop
    {
